...
apt update -q
apt upgrade -yq
apt install -yq curl postgresql postgresql-contrib git snapd python3 python3-pip python3-venv fuse ufw dnsutils fastfetch net-tools htop network-manager linux-headers-$(uname -r)
